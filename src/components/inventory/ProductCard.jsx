...
export const ProductCard = ({ product, onClick }) => {
  return (
    <div 
      ...
      className="bg-white rounded-2xl p-3 flex gap-4 items-center border border-slate-100 active:bg-slate-50 transition-all cursor-pointer"
    >
      ...
      <div className="text-right flex-shrink-0 bg-emerald-50 px-3 py-2 rounded-xl border border-emerald-100">
        <div className="text-sm font-bold text-emerald-600 uppercase tracking-wider mb-0.5">Precio</div>
        <div className="font-bold text-emerald-700 text-xl leading-none">
